...
public class Trigger_Script_Button : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            (triggerType == TriggerType.Enable))
        {
            ...
            if (invisibleController != null)
            {
                ...
                //if (targetObject.GetComponent<Animator>() != null) targetObject.GetComponent<Animator>().SetTrigger("trigger");
            }
